...
HASHICORP_NODE_PROVISIONING_FILE=${HASHICORP_NODE_PROVISIONING_FILE:-"/.swarmshicorp-node-provisioning/activate"}
...
cat <<EOT > "$HASHICORP_NODE_PROVISIONING_FILE"
  $HASHICORP_NODE_ADVERTISE
  $HASHICORP_NODE_ADVERTISE_WAN
  $HASHICORP_NODE_BIND
  $HASHICORP_NODE_CLIENT
EOT
